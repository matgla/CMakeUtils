...
function (add_clang_tidy filter_files)
  if (NOT TARGET run_clang_tidy)
    ...
    add_custom_target(filter_compile_commands
      COMMAND ${clang_tidy_python_executable} -m compile-commands --files ${PROJECT_BINARY_DIR}/compile-commands.json --filter_files=${suppression}
      WORKING_DIRECTORY
    ...
    add_custom_target(run_clang_tidy
      ...
      COMMAND ${RUN_CLANG_TIDY_EXE} -p ${PROJECT_BINARY_DIR}/compile-commands.json -j${cpus}
      VERBATIM
    )

    add_custom_command(OUTPUT clang_tidy_report.txt 
      COMMAND ${RUN_CLANG_TIDY_EXE} -p ${PROJECT_BINARY_DIR}/compile-commands.json -j${cpus} > clang_tidy_report.txt
      DEPENDS filter_compile_commands 
      VERBATIM 
    )
